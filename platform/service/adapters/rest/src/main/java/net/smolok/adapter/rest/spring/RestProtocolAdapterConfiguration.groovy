...
import net.smolok.adapter.rest.RestProtocolAdapter;
...
public class RestProtocolAdapterConfiguration {
    ...
    RestProtocolAdapter restProtcolAdapter(
            ...
            @Value('${rest.contentType:application/json}') String contentType) {
        return new RestProtocolAdapter(payloadEncoding, httpPort, contentType);
    }
